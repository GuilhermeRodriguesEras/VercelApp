...
def gerar_pdf_proposta(dados_front, dados_orcamento, contato, orcamento_id):
    ...
    # Estilo especial com keepWithNext=True para manter o título junto com a tabela
    ...
    story.append(header)
    story.append(Spacer(1, 3 * mm))  # Espaçamento reduzido de 6mm para 3mm
    ...
    story.append(Spacer(1, 3 * mm))  # Espaçamento reduzido de 5mm para 3mm
    ...
    # Título da seção com keepWithNext ativado
    ...
    total_linhas = len(corpo_itens)
    last_row_idx = total_linhas - 1  # Índice explícito em vez de -1
